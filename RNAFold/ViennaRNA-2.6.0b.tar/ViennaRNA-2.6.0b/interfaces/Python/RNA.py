...
class fold_compound(object):
    ...
    def sc_mod_json(self, json, modification_sites):
        return _RNA.fold_compound_sc_mod_json(self, json, modification_sites)

    def sc_mod_jsonfile(self, jsonfile, modification_sites):
        return _RNA.fold_compound_sc_mod_jsonfile(self, jsonfile, modification_sites)

    def sc_mod(self, params, modification_sites):
        return _RNA.fold_compound_sc_mod(self, params, modification_sites)

    def sc_mod_m6A(self, modification_sites):
        return _RNA.fold_compound_sc_mod_m6A(self, modification_sites)

    def sc_mod_pseudouridine(self, modification_sites):
        return _RNA.fold_compound_sc_mod_pseudouridine(self, modification_sites)

    def sc_mod_inosine(self, modification_sites):
        return _RNA.fold_compound_sc_mod_inosine(self, modification_sites)

    def sc_mod_7DA(self, modification_sites):
        return _RNA.fold_compound_sc_mod_7DA(self, modification_sites)

    def sc_mod_purine(self, modification_sites):
        return _RNA.fold_compound_sc_mod_purine(self, modification_sites)

    def sc_mod_dihydrouridine(self, modification_sites):
        return _RNA.fold_compound_sc_mod_dihydrouridine(self, modification_sites)
