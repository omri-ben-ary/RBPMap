...
The corrections for loop and stack are taken from Einert and Netz, 2011 All corrections ruterned are in dcal/mol Collaboration diagram for Energy Parameters\+:
% FIG 0
...
file \mbox{\hyperlink{salt_8h}{salt.\+h}}
\begin{DoxyCompactList}\small\item\em Functions to compute salt correction. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\item[\mbox{\hyperlink{wrappers__wrappers000116}{SWIG Wrapper Notes}}]This function is attached to \mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\+\_\+fc\+\_\+s}} objects as overloaded {\bfseries{params\+\_\+subst()}} method.
...
\end{DoxyParams}
\begin{DoxyRefDesc}{SWIG Wrapper Notes}
\item[\mbox{\hyperlink{wrappers__wrappers000117}{SWIG Wrapper Notes}}]This function is attached to \mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\+\_\+fc\+\_\+s}} objects as overloaded {\bfseries{exp\+\_\+params\+\_\+subst()}} method.
...
\end{DoxyParams}
\begin{DoxyRefDesc}{SWIG Wrapper Notes}
\item[\mbox{\hyperlink{wrappers__wrappers000118}{SWIG Wrapper Notes}}]This function is attached to \mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\+\_\+fc\+\_\+s}} objects as overloaded {\bfseries{exp\+\_\+params\+\_\+rescale()}} method.
...
\end{DoxyParams}
\begin{DoxyRefDesc}{SWIG Wrapper Notes}
\item[\mbox{\hyperlink{wrappers__wrappers000119}{SWIG Wrapper Notes}}]This function is attached to \mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\+\_\+fc\+\_\+s}} objects as overloaded {\bfseries{params\+\_\+reset()}} method.
...
\end{DoxyParams}
\begin{DoxyRefDesc}{SWIG Wrapper Notes}
\item[\mbox{\hyperlink{wrappers__wrappers000120}{SWIG Wrapper Notes}}]This function is attached to \mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\+\_\+fc\+\_\+s}} objects as overloaded {\bfseries{exp\+\_\+params\+\_\+reset()}} method.
...
\end{DoxyReturn}
\mbox{\Hypertarget{group__energy__parameters_gacbd81622ca7e9f4b6ce46722179dd40a}\label{group__energy__parameters_gacbd81622ca7e9f4b6ce46722179dd40a}} 
\index{Energy Parameters@{Energy Parameters}!vrna\_salt\_loop@{vrna\_salt\_loop}}
\index{vrna\_salt\_loop@{vrna\_salt\_loop}!Energy Parameters@{Energy Parameters}}
\doxysubsubsection{\texorpdfstring{vrna\_salt\_loop()}{vrna\_salt\_loop()}}
{\footnotesize\ttfamily double vrna\+\_\+salt\+\_\+loop (\begin{DoxyParamCaption}\item[{int}]{L,  }\item[{double}]{salt,  }\item[{double}]{T }\end{DoxyParamCaption})}



{\ttfamily \#include $<$\mbox{\hyperlink{salt_8h}{Vienna\+RNA/params/salt.\+h}}$>$}
...
\begin{DoxyParams}{Parameters}
{\em L} & backbone number in loop \\
\hline
{\em salt} & salt concentration (M) \\
\hline
{\em T} & absolute temperature (K)\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Salt correction for loop in dcal/mol 
\end{DoxyReturn}
\mbox{\Hypertarget{group__energy__parameters_ga8368ed4693a396299f3d6c96b3083b20}\label{group__energy__parameters_ga8368ed4693a396299f3d6c96b3083b20}} 
\index{Energy Parameters@{Energy Parameters}!vrna\_salt\_loop\_int@{vrna\_salt\_loop\_int}}
\index{vrna\_salt\_loop\_int@{vrna\_salt\_loop\_int}!Energy Parameters@{Energy Parameters}}
\doxysubsubsection{\texorpdfstring{vrna\_salt\_loop\_int()}{vrna\_salt\_loop\_int()}}
{\footnotesize\ttfamily int vrna\+\_\+salt\+\_\+loop\+\_\+int (\begin{DoxyParamCaption}\item[{int}]{L,  }\item[{double}]{salt,  }\item[{double}]{T }\end{DoxyParamCaption})}
...
This functions is same as vrna\+\_\+salt\+\_\+loop but returns rounded salt correction in integer

\begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{group__energy__parameters_gacbd81622ca7e9f4b6ce46722179dd40a}{vrna\+\_\+salt\+\_\+loop}}
\end{DoxySeeAlso}
...
\end{DoxyReturn}
\mbox{\Hypertarget{group__energy__parameters_gacda239ca49b5cb0fbe6734c48603d1c8}\label{group__energy__parameters_gacda239ca49b5cb0fbe6734c48603d1c8}} 
\index{Energy Parameters@{Energy Parameters}!vrna\_salt\_stack@{vrna\_salt\_stack}}
\index{vrna\_salt\_stack@{vrna\_salt\_stack}!Energy Parameters@{Energy Parameters}}
\doxysubsubsection{\texorpdfstring{vrna\_salt\_stack()}{vrna\_salt\_stack()}}
{\footnotesize\ttfamily int vrna\+\_\+salt\+\_\+stack (\begin{DoxyParamCaption}\item[{double}]{salt,  }\item[{double}]{T }\end{DoxyParamCaption})}
