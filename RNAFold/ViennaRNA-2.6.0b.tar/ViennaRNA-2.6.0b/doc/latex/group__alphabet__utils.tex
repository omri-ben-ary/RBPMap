...
short $\ast$ \mbox{\hyperlink{group__alphabet__utils_gafbffc82595f34c9c4eaf9ba22547b42a}{vrna\+\_\+seq\+\_\+encode\+\_\+simple}} (const char $\ast$sequence, \mbox{\hyperlink{group__model__details_ga1f8a10e12a0a1915f2a4eff0b28ea17c}{vrna\+\_\+md\+\_\+t}} $\ast$md)
...
\item[\mbox{\hyperlink{wrappers__wrappers000151}{SWIG Wrapper Notes}}]In the target scripting language, this function is wrapped as overloaded function {\itshape seq\+\_\+encode()} where the last parameter, the {\itshape model\+\_\+details} data structure, is optional. If it is omitted, default model settings are applied, i.\+e. default nucleotide letter conversion. The wrapped function returns a list/tuple of integer representations of the input sequence. \end{DoxyRefDesc}
...
\doxysubsubsection{\texorpdfstring{vrna\_seq\_encode\_simple()}{vrna\_seq\_encode\_simple()}}
