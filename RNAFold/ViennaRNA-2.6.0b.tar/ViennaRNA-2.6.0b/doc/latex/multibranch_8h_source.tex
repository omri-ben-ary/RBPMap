...
\DoxyCodeLine{00055\ \mbox{\hyperlink{group__eval__loops__mb_ga91af6d5fcb0aef243a4071cf9e718020}{vrna\_E\_mb\_loop\_stack}}(\mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}}\ *fc,}
...
\DoxyCodeLine{00098\ \textcolor{keyword}{typedef}\ \textcolor{keyword}{struct\ }vrna\_mx\_pf\_aux\_ml\_s\ *\mbox{\hyperlink{group__eval__loops__mb_ga39a8cc1385dcb542a60a9393cde6a1e3}{vrna\_mx\_pf\_aux\_ml\_t}};}
\DoxyCodeLine{00099\ }
\DoxyCodeLine{00100\ }
...
\DoxyCodeLine{00164\ \mbox{\hyperlink{group__mfe__backtracking_ga5b62d56c9d47c1e8792b02cd6b95e78b}{vrna\_BT\_mb\_loop}}(\mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}}\ \ *fc,}
...
\DoxyCodeLine{00174\ vrna\_BT\_mb\_loop\_split(\mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}}\ \ *fc,}
\DoxyCodeLine{00175\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ *i,}
...
\DoxyCodeLine{00179\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ *component1,}
\DoxyCodeLine{00180\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ *component2,}
\DoxyCodeLine{00181\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{group__data__structures_structvrna__bp__stack__s}{vrna\_bp\_stack\_t}}\ \ \ \ \ \ \ *bp\_stack,}
\DoxyCodeLine{00182\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ *stack\_count);}
\DoxyCodeLine{00183\ }
\DoxyCodeLine{00184\ }
\DoxyCodeLine{00190\ \textcolor{preprocessor}{\#ifndef\ VRNA\_DISABLE\_BACKWARD\_COMPATIBILITY}}
\DoxyCodeLine{00191\ }
\DoxyCodeLine{00216\ PRIVATE\ INLINE\ \textcolor{keywordtype}{int}}
\DoxyCodeLine{00217\ E\_MLstem(\textcolor{keywordtype}{int}\ \ \ \ \ \ \ \ \ \ type,}
...
\DoxyCodeLine{00221\ \{}
\DoxyCodeLine{00222\ \ \ \textcolor{keywordtype}{int}\ energy\ =\ 0;}
\DoxyCodeLine{00223\ }
\DoxyCodeLine{00224\ \ \ \textcolor{keywordflow}{if}\ (si1\ >=\ 0\ \&\&\ sj1\ >=\ 0)}
\DoxyCodeLine{00225\ \ \ \ \ energy\ +=\ P-\/>mismatchM[type][si1][sj1];}
\DoxyCodeLine{00226\ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (si1\ >=\ 0)}
\DoxyCodeLine{00227\ \ \ \ \ energy\ +=\ P-\/>dangle5[type][si1];}
\DoxyCodeLine{00228\ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (sj1\ >=\ 0)}
\DoxyCodeLine{00229\ \ \ \ \ energy\ +=\ P-\/>dangle3[type][sj1];}
\DoxyCodeLine{00230\ }
\DoxyCodeLine{00231\ \ \ \textcolor{keywordflow}{if}\ (type\ >\ 2)}
\DoxyCodeLine{00232\ \ \ \ \ energy\ +=\ P-\/>TerminalAU;}
\DoxyCodeLine{00233\ }
\DoxyCodeLine{00234\ \ \ energy\ +=\ P-\/>MLintern[type];}
\DoxyCodeLine{00235\ }
\DoxyCodeLine{00236\ \ \ \textcolor{keywordflow}{return}\ energy;}
\DoxyCodeLine{00237\ \}}
\DoxyCodeLine{00238\ }
\DoxyCodeLine{00239\ }
\DoxyCodeLine{00246\ PRIVATE\ INLINE\ \mbox{\hyperlink{group__data__structures_ga31125aeace516926bf7f251f759b6126}{FLT\_OR\_DBL}}}
\DoxyCodeLine{00247\ exp\_E\_MLstem(\textcolor{keywordtype}{int}\ \ \ \ \ \ \ \ \ \ \ \ \ \ type,}
\DoxyCodeLine{00248\ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ \ \ \ \ \ \ \ \ \ \ \ \ \ si1,}
\DoxyCodeLine{00249\ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ \ \ \ \ \ \ \ \ \ \ \ \ \ sj1,}
\DoxyCodeLine{00250\ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{group__energy__parameters_structvrna__exp__param__s}{vrna\_exp\_param\_t}}\ *P)}
\DoxyCodeLine{00251\ \{}
\DoxyCodeLine{00252\ \ \ \textcolor{keywordtype}{double}\ energy\ =\ 1.0;}
\DoxyCodeLine{00253\ }
\DoxyCodeLine{00254\ \ \ \textcolor{keywordflow}{if}\ (si1\ >=\ 0\ \&\&\ sj1\ >=\ 0)}
\DoxyCodeLine{00255\ \ \ \ \ energy\ =\ P-\/>expmismatchM[type][si1][sj1];}
\DoxyCodeLine{00256\ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (si1\ >=\ 0)}
\DoxyCodeLine{00257\ \ \ \ \ energy\ =\ P-\/>expdangle5[type][si1];}
\DoxyCodeLine{00258\ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (sj1\ >=\ 0)}
\DoxyCodeLine{00259\ \ \ \ \ energy\ =\ P-\/>expdangle3[type][sj1];}
\DoxyCodeLine{00260\ }
\DoxyCodeLine{00261\ \ \ \textcolor{keywordflow}{if}\ (type\ >\ 2)}
\DoxyCodeLine{00262\ \ \ \ \ energy\ *=\ P-\/>expTermAU;}
\DoxyCodeLine{00263\ }
\DoxyCodeLine{00264\ \ \ energy\ *=\ P-\/>expMLintern[type];}
\DoxyCodeLine{00265\ \ \ \textcolor{keywordflow}{return}\ (\mbox{\hyperlink{group__data__structures_ga31125aeace516926bf7f251f759b6126}{FLT\_OR\_DBL}})energy;}
\DoxyCodeLine{00266\ \}}
\DoxyCodeLine{00267\ }
\DoxyCodeLine{00268\ }
