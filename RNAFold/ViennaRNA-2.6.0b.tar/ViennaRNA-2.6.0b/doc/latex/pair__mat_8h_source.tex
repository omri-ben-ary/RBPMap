...
\DoxyCodeLine{00096\ }
\DoxyCodeLine{00097\ \ \ \ \ \textcolor{keywordflow}{if}\ (nonstandards\ !=\ NULL)\ \{}
\DoxyCodeLine{00098\ \ \ \ \ \ \ \textcolor{comment}{/*\ allow\ nonstandard\ bp's\ */}}
\DoxyCodeLine{00099\ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (i\ =\ 0;\ i\ <\ (int)strlen(nonstandards);\ i\ +=\ 2)}
\DoxyCodeLine{00100\ \ \ \ \ \ \ \ \ pair[encode\_char(nonstandards[i])]}
\DoxyCodeLine{00101\ \ \ \ \ \ \ \ \ [encode\_char(nonstandards[i\ +\ 1])]\ =\ 7;}
\DoxyCodeLine{00102\ \ \ \ \ \}}
\DoxyCodeLine{00103\ }
...
\DoxyCodeLine{00163\ \ \ \textcolor{keywordtype}{short}\ \ \ \ \ \ \ \ \ *S\ =\ (\textcolor{keywordtype}{short}\ *)\mbox{\hyperlink{group__utils_gafae44c31c8772450d6c674a582be3e3c}{vrna\_alloc}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{short})\ *\ (l\ +\ 2));}
\DoxyCodeLine{00164\ }
