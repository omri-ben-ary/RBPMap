...
\begin{DoxyCompactItemize}
\item 
float $\ast$$\ast$ \mbox{\hyperlink{group__file__utils_gafea21dc418a77f5fe583d63d9972da9f}{get\+\_\+ribosum}} (const char $\ast$$\ast$Alseq, int n\+\_\+seq, int length)
\begin{DoxyCompactList}\small\item\em Retrieve a Ribo\+Sum Scoring Matrix for a given Alignment. \end{DoxyCompactList}\item 
float $\ast$$\ast$ \mbox{\hyperlink{group__file__utils_gaa6abc35f1fc474c0826bae6c7ce51583}{readribosum}} (char $\ast$name)
...
\index{Files and I/O@{Files and I/O}!get\_ribosum@{get\_ribosum}}
\index{get\_ribosum@{get\_ribosum}!Files and I/O@{Files and I/O}}
\doxysubsubsection{\texorpdfstring{get\_ribosum()}{get\_ribosum()}}
{\footnotesize\ttfamily float $\ast$$\ast$ get\+\_\+ribosum (\begin{DoxyParamCaption}\item[{const char $\ast$$\ast$}]{Alseq,  }\item[{int}]{n\+\_\+seq,  }\item[{int}]{length }\end{DoxyParamCaption})}



{\ttfamily \#include $<$\mbox{\hyperlink{ribo_8h}{Vienna\+RNA/ribo.\+h}}$>$}



Retrieve a Ribo\+Sum Scoring Matrix for a given Alignment. 
...
\index{Files and I/O@{Files and I/O}!readribosum@{readribosum}}
\index{readribosum@{readribosum}!Files and I/O@{Files and I/O}}
\doxysubsubsection{\texorpdfstring{readribosum()}{readribosum()}}
{\footnotesize\ttfamily float $\ast$$\ast$ readribosum (\begin{DoxyParamCaption}\item[{char $\ast$}]{name }\end{DoxyParamCaption})}
