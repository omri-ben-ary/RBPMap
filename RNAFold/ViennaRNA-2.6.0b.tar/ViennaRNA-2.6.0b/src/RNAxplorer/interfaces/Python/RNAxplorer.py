...
def barrier_estimate_2D(seq, md_p, s1, s2, maximum_distance1, maximum_distance2):
    r"""
...
def computeInitialDistortion(vc, s1, s2):
    r"""
...
def computeDistortion(vc, s0, s1, s2):
    r"""
...
def addStructuresToGrid(grid, structures):
    r"""
...
def kl_init_datastructures(vc, s1, s2, x, y):
    r"""
...
def free_kl_soft_constraints(data):
    r"""
...
def kl_pseudo_energy(i, j, k, l, decomp, data):
    r"""
...
def kl_exp_pseudo_energy(i, j, k, l, decomp, data):
    r"""
...
def fillGridWithSamples(vc, grid, s1, s2, maxIterations):
    r"""
...
def fillGridStepwiseBothRef(vc, grid, relaxFactor, relax, shift, shift_to_first, verbose, maxIterations, maxSteps):
    r"""
...
def fillGridStepwiseFirstRef(vc, grid, relaxFactor, relax, verbose, maxIterations, maxSteps):
    r"""
...
def fillGridStepwiseSecondRef(vc, grid, relaxFactor, relax, verbose, maxIterations, maxSteps):
    r"""
...
def addSoftconstraints(vc, s1, s2, distortion_x, distortion_y):
    r"""
...
def estimate_landscape(vc, s1, s2, maxIterations, extended_options):
    r"""
...
def addStructure(grid, structure):
    r"""
...
def createModelDetails(circ, uniq_ML, compute_bpp, betaScale):
    r"""
...
def computeDistortions(fc, structures, numberOfStructures):
    r"""
...
def computeDistortionsMaxDist(fc, structures, numberOfStructures, distances):
    r"""
...
def getMaximalPossibleBPdistance(sequence, structure):
    r"""
...
def rxp_computeDistortionsWRTMaxDistance(fc, structures, numberOfStructures, maxDistances):
    r"""
...
def rxp_computeDistortions(fc, structures, numberOfStructures, mfe, mfeStructure):
    r"""
...
def rxp_computeDistortionsWithMFE(fc, structures, numberOfStructures):
    r"""
...
def print_matrix(desc, m, n, a, lda):
    r"""
...
def fillGridStepwiseFirstRef_MD(vc, grid, relaxFactor, relax, verbose, maxIterations, maxSteps):
    r"""
...
def fillGridStepwiseSecondRef_MD(vc, grid, relaxFactor, relax, verbose, maxIterations, maxSteps):
    r"""
...
def estimate_landscapeMD(vc, refStructures, numberOfReferences, maxIterations, extended_options, indicesAndPercentages, lengthIndices):
    r"""
...
def addSoftconstraintsMD(vc, structures, numberOfReferences, distortions, repel):
    r"""
...
def sc_exp_f_dist_class(i, j, k, l, decomp, data):
    r"""
...
def sc_f_dist_class(i, j, k, l, decomp, data):
    r"""
...
def sc_dist_class_destroy(data):
    r"""
...
def sc_dist_class_add_ref(d, ref_struct):
    r"""
...
def insert_meshpoint(s, en, list, maxEntries):
    r"""
...
def insert_meshpoint_with_struct_energy(s, en, struct_en, list, maxEntries):
    r"""
...
def init_structure_queue(queue):
    r"""
...
def clear_structure_queue(queue):
    r"""
...
def insert_structure_in_queue(queue, s, en, neighbor_list, neighbor_cnt, bestNeighborEn, bestNeighborIdx, maxStructs):
    r"""
...
def sort_neighbors_by_energy_asc(p1, p2):
    r"""
...
def structureWalk(seq, structure, method):
    r"""
...
def getPosition(array, value, array_size):
    r"""
...
def convertVRNA_PATH_toList(path):
    r"""
...
def levelSaddlePoint(seq, s1, s2, maxIterations, maxKeep, method, maxStorage):
    r"""
...
def levelSaddlePoint2(seq, s1, s2, iteration, maxIterations, maxKeep, maxStorage, maximum_distance1, maximum_distance2):
    r"""
...
def getSaddlePoint(foldingPath):
    r"""
...
def add_repulsion(fc, structure, strength):
    r"""
...
def change_repulsion(fc, id, strength):
    r"""
...
def rnax_change_repulsion(fc, id, strength):
    r"""
