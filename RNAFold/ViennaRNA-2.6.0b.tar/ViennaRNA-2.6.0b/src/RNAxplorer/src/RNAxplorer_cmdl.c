/*
  ...
  gengetopt -i RNAxplorer.ggo --file-name=RNAxplorer_cmdl --include-getopt --default-optional --func-name=RNAxplorer_cmdline_parser --arg-struct-name=RNAxplorer_args_info
