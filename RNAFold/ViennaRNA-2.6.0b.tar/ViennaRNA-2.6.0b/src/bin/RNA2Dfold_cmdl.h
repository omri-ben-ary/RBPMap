...
's maximum occurreces */
 ...
 help description.  */
  double pfScale_arg;	/**< @brief scaling factor for pf to avoid overflows
  
.  */
  char * pfScale_orig;	/**< @brief scaling factor for pf to avoid overflows
  
 original value given at command line.  */
  const char *pfScale_help; /**< @brief scaling factor for pf to avoid overflows
