...
init_full_help_array(void)
{
  ...
  RNAheat_args_info_full_help[29] = RNAheat_args_info_detailed_help[39];
  RNAheat_args_info_full_help[30] = RNAheat_args_info_detailed_help[41];
  ...
  RNAheat_args_info_full_help[34] = RNAheat_args_info_detailed_help[46];
  RNAheat_args_info_full_help[35] = 0; 
  
}

const char *RNAheat_args_info_full_help[36];
...
init_help_array(void)
{
  ...
  RNAheat_args_info_help[25] = RNAheat_args_info_detailed_help[39];
  RNAheat_args_info_help[26] = RNAheat_args_info_detailed_help[44];
  RNAheat_args_info_help[27] = RNAheat_args_info_detailed_help[45];
  RNAheat_args_info_help[28] = RNAheat_args_info_detailed_help[46];
  RNAheat_args_info_help[29] = 0; 
  
}

const char *RNAheat_args_info_help[30];
...
void init_args_info(struct RNAheat_args_info *args_info)
{
  ...
  args_info->salt_help = RNAheat_args_info_detailed_help[38] ;
  args_info->paramFile_help = RNAheat_args_info_detailed_help[39] ;
  args_info->nsp_help = RNAheat_args_info_detailed_help[41] ;
  args_info->energyModel_help = RNAheat_args_info_detailed_help[43] ;
  args_info->gquad_help = RNAheat_args_info_detailed_help[44] ;
  args_info->circ_help = RNAheat_args_info_detailed_help[45] ;
