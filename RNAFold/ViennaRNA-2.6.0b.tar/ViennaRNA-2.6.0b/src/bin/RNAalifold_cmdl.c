...
init_full_help_array(void)
{
  ...
  RNAalifold_args_info_full_help[62] = RNAalifold_args_info_detailed_help[88];
  RNAalifold_args_info_full_help[63] = RNAalifold_args_info_detailed_help[90];
  RNAalifold_args_info_full_help[64] = RNAalifold_args_info_detailed_help[92];
  RNAalifold_args_info_full_help[65] = RNAalifold_args_info_detailed_help[93];
  RNAalifold_args_info_full_help[66] = RNAalifold_args_info_detailed_help[95];
  RNAalifold_args_info_full_help[67] = 0; 
  
}

const char *RNAalifold_args_info_full_help[68];
...
init_help_array(void)
{
  ...
  RNAalifold_args_info_help[53] = RNAalifold_args_info_detailed_help[88];
  RNAalifold_args_info_help[54] = RNAalifold_args_info_detailed_help[95];
...
void init_args_info(struct RNAalifold_args_info *args_info)
{
  ...
  args_info->salt_help = RNAalifold_args_info_detailed_help[81] ;
  args_info->cfactor_help = RNAalifold_args_info_detailed_help[82] ;
  args_info->nfactor_help = RNAalifold_args_info_detailed_help[83] ;
  args_info->endgaps_help = RNAalifold_args_info_detailed_help[84] ;
  args_info->ribosum_file_help = RNAalifold_args_info_detailed_help[85] ;
  args_info->ribosum_scoring_help = RNAalifold_args_info_detailed_help[86] ;
  args_info->old_help = RNAalifold_args_info_detailed_help[87] ;
  args_info->paramFile_help = RNAalifold_args_info_detailed_help[88] ;
  args_info->nsp_help = RNAalifold_args_info_detailed_help[90] ;
  args_info->energyModel_help = RNAalifold_args_info_detailed_help[92] ;
  args_info->betaScale_help = RNAalifold_args_info_detailed_help[93] ;
