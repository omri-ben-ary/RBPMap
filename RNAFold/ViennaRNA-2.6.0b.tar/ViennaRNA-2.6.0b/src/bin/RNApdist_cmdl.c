...
init_full_help_array(void)
{
  ...
  RNApdist_args_info_full_help[8] = RNApdist_args_info_detailed_help[9];
  RNApdist_args_info_full_help[9] = RNApdist_args_info_detailed_help[11];
  RNApdist_args_info_full_help[10] = RNApdist_args_info_detailed_help[12];
  ...
  RNApdist_args_info_full_help[14] = RNApdist_args_info_detailed_help[17];
  RNApdist_args_info_full_help[15] = RNApdist_args_info_detailed_help[18];
  RNApdist_args_info_full_help[16] = RNApdist_args_info_detailed_help[19];
  RNApdist_args_info_full_help[17] = RNApdist_args_info_detailed_help[20];
  RNApdist_args_info_full_help[18] = RNApdist_args_info_detailed_help[22];
  RNApdist_args_info_full_help[19] = RNApdist_args_info_detailed_help[24];
  RNApdist_args_info_full_help[20] = RNApdist_args_info_detailed_help[25];
  RNApdist_args_info_full_help[21] = 0; 
  
}

const char *RNApdist_args_info_full_help[22];
...
init_help_array(void)
{
  ...
  RNApdist_args_info_help[8] = RNApdist_args_info_detailed_help[9];
  RNApdist_args_info_help[9] = RNApdist_args_info_detailed_help[11];
  RNApdist_args_info_help[10] = RNApdist_args_info_detailed_help[12];
  ...
  RNApdist_args_info_help[14] = RNApdist_args_info_detailed_help[17];
  RNApdist_args_info_help[15] = RNApdist_args_info_detailed_help[18];
  RNApdist_args_info_help[16] = RNApdist_args_info_detailed_help[19];
  RNApdist_args_info_help[17] = RNApdist_args_info_detailed_help[20];
  RNApdist_args_info_help[18] = RNApdist_args_info_detailed_help[25];
  RNApdist_args_info_help[19] = 0; 
  
}

const char *RNApdist_args_info_help[20];
...
void init_args_info(struct RNApdist_args_info *args_info)
{
  ...
  args_info->noconv_help = RNApdist_args_info_detailed_help[5] ;
  args_info->compare_help = RNApdist_args_info_detailed_help[7] ;
  args_info->backtrack_help = RNApdist_args_info_detailed_help[9] ;
  args_info->temp_help = RNApdist_args_info_detailed_help[12] ;
  args_info->noTetra_help = RNApdist_args_info_detailed_help[13] ;
  args_info->dangles_help = RNApdist_args_info_detailed_help[14] ;
  args_info->noLP_help = RNApdist_args_info_detailed_help[15] ;
  args_info->noGU_help = RNApdist_args_info_detailed_help[17] ;
  args_info->noClosingGU_help = RNApdist_args_info_detailed_help[18] ;
  args_info->salt_help = RNApdist_args_info_detailed_help[19] ;
  args_info->paramFile_help = RNApdist_args_info_detailed_help[20] ;
  args_info->nsp_help = RNApdist_args_info_detailed_help[22] ;
  args_info->energyModel_help = RNApdist_args_info_detailed_help[24] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVX:B::T:4d:P:e:", long_options, &option_index);
