...
init_full_help_array(void)
{
  ...
  RNAfold_args_info_full_help[51] = RNAfold_args_info_detailed_help[78];
  RNAfold_args_info_full_help[52] = RNAfold_args_info_detailed_help[80];
  RNAfold_args_info_full_help[53] = RNAfold_args_info_detailed_help[82];
  RNAfold_args_info_full_help[54] = RNAfold_args_info_detailed_help[83];
  RNAfold_args_info_full_help[55] = RNAfold_args_info_detailed_help[85];
  RNAfold_args_info_full_help[56] = 0; 
  
}

const char *RNAfold_args_info_full_help[57];
...
init_help_array(void)
{
  ...
  RNAfold_args_info_help[39] = RNAfold_args_info_detailed_help[78];
  RNAfold_args_info_help[40] = RNAfold_args_info_detailed_help[85];
  RNAfold_args_info_help[41] = 0; 
  
}

const char *RNAfold_args_info_help[42];
...
void init_args_info(struct RNAfold_args_info *args_info)
{
  ...
  args_info->salt_help = RNAfold_args_info_detailed_help[77] ;
  args_info->paramFile_help = RNAfold_args_info_detailed_help[78] ;
  args_info->nsp_help = RNAfold_args_info_detailed_help[80] ;
  args_info->energyModel_help = RNAfold_args_info_detailed_help[82] ;
  args_info->betaScale_help = RNAfold_args_info_detailed_help[83] ;
