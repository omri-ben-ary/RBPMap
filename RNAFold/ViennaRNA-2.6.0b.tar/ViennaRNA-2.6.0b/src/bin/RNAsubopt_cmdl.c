...
init_full_help_array(void)
{
  ...
  RNAsubopt_args_info_full_help[52] = RNAsubopt_args_info_detailed_help[79];
  RNAsubopt_args_info_full_help[53] = RNAsubopt_args_info_detailed_help[81];
  RNAsubopt_args_info_full_help[54] = RNAsubopt_args_info_detailed_help[83];
  RNAsubopt_args_info_full_help[55] = RNAsubopt_args_info_detailed_help[85];
  RNAsubopt_args_info_full_help[56] = 0; 
  
}

const char *RNAsubopt_args_info_full_help[57];
...
init_help_array(void)
{
  ...
  RNAsubopt_args_info_help[36] = RNAsubopt_args_info_detailed_help[75];
  RNAsubopt_args_info_help[37] = RNAsubopt_args_info_detailed_help[77];
  RNAsubopt_args_info_help[38] = RNAsubopt_args_info_detailed_help[85];
  RNAsubopt_args_info_help[39] = 0; 
  
}

const char *RNAsubopt_args_info_help[40];
...
void init_args_info(struct RNAsubopt_args_info *args_info)
{
  ...
  args_info->salt_help = RNAsubopt_args_info_detailed_help[74] ;
  args_info->logML_help = RNAsubopt_args_info_detailed_help[75] ;
  args_info->paramFile_help = RNAsubopt_args_info_detailed_help[77] ;
  args_info->nsp_help = RNAsubopt_args_info_detailed_help[79] ;
  args_info->energyModel_help = RNAsubopt_args_info_detailed_help[81] ;
  args_info->betaScale_help = RNAsubopt_args_info_detailed_help[83] ;
