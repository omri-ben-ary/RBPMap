...
init_full_help_array(void)
{
  ...
  RNAplex_args_info_full_help[11] = RNAplex_args_info_detailed_help[16];
  RNAplex_args_info_full_help[12] = RNAplex_args_info_detailed_help[17];
  RNAplex_args_info_full_help[13] = RNAplex_args_info_detailed_help[18];
  RNAplex_args_info_full_help[14] = RNAplex_args_info_detailed_help[19];
  RNAplex_args_info_full_help[15] = RNAplex_args_info_detailed_help[21];
  ...
  RNAplex_args_info_full_help[19] = RNAplex_args_info_detailed_help[27];
  RNAplex_args_info_full_help[20] = RNAplex_args_info_detailed_help[28];
  RNAplex_args_info_full_help[21] = RNAplex_args_info_detailed_help[29];
  RNAplex_args_info_full_help[22] = RNAplex_args_info_detailed_help[30];
  RNAplex_args_info_full_help[23] = RNAplex_args_info_detailed_help[31];
  RNAplex_args_info_full_help[24] = RNAplex_args_info_detailed_help[32];
  RNAplex_args_info_full_help[25] = RNAplex_args_info_detailed_help[34];
  RNAplex_args_info_full_help[26] = RNAplex_args_info_detailed_help[36];
  RNAplex_args_info_full_help[27] = RNAplex_args_info_detailed_help[38];
  RNAplex_args_info_full_help[28] = RNAplex_args_info_detailed_help[40];
  RNAplex_args_info_full_help[29] = RNAplex_args_info_detailed_help[42];
  RNAplex_args_info_full_help[30] = RNAplex_args_info_detailed_help[43];
  RNAplex_args_info_full_help[31] = RNAplex_args_info_detailed_help[44];
  RNAplex_args_info_full_help[32] = RNAplex_args_info_detailed_help[46];
  ...
  RNAplex_args_info_full_help[36] = 0; 
  
}

const char *RNAplex_args_info_full_help[37];
...
init_help_array(void)
{
  ...
  RNAplex_args_info_help[14] = RNAplex_args_info_detailed_help[19];
  RNAplex_args_info_help[15] = RNAplex_args_info_detailed_help[21];
  RNAplex_args_info_help[16] = RNAplex_args_info_detailed_help[23];
  RNAplex_args_info_help[17] = RNAplex_args_info_detailed_help[25];
  RNAplex_args_info_help[18] = RNAplex_args_info_detailed_help[27];
  RNAplex_args_info_help[19] = RNAplex_args_info_detailed_help[32];
  RNAplex_args_info_help[20] = RNAplex_args_info_detailed_help[34];
  RNAplex_args_info_help[21] = RNAplex_args_info_detailed_help[36];
  RNAplex_args_info_help[22] = RNAplex_args_info_detailed_help[38];
  RNAplex_args_info_help[23] = RNAplex_args_info_detailed_help[40];
  RNAplex_args_info_help[24] = RNAplex_args_info_detailed_help[42];
  RNAplex_args_info_help[25] = RNAplex_args_info_detailed_help[43];
  RNAplex_args_info_help[26] = RNAplex_args_info_detailed_help[44];
  RNAplex_args_info_help[27] = RNAplex_args_info_detailed_help[46];
  RNAplex_args_info_help[28] = RNAplex_args_info_detailed_help[48];
  RNAplex_args_info_help[29] = RNAplex_args_info_detailed_help[50];
  RNAplex_args_info_help[30] = RNAplex_args_info_detailed_help[52];
  RNAplex_args_info_help[31] = 0; 
  
}

const char *RNAplex_args_info_help[32];
...
void init_args_info(struct RNAplex_args_info *args_info)
{
  ...
  args_info->paramFile_help = RNAplex_args_info_detailed_help[14] ;
  args_info->temp_help = RNAplex_args_info_detailed_help[18] ;
  args_info->interaction_length_help = RNAplex_args_info_detailed_help[19] ;
  args_info->extension_cost_help = RNAplex_args_info_detailed_help[21] ;
  args_info->salt_help = RNAplex_args_info_detailed_help[23] ;
  args_info->saltInit_help = RNAplex_args_info_detailed_help[24] ;
  args_info->probe_mode_help = RNAplex_args_info_detailed_help[25] ;
  args_info->probe_concentration_help = RNAplex_args_info_detailed_help[27] ;
  args_info->na_concentration_help = RNAplex_args_info_detailed_help[28] ;
  args_info->mg_concentration_help = RNAplex_args_info_detailed_help[29] ;
  args_info->k_concentration_help = RNAplex_args_info_detailed_help[30] ;
  args_info->tris_concentration_help = RNAplex_args_info_detailed_help[31] ;
  args_info->fast_folding_help = RNAplex_args_info_detailed_help[32] ;
  args_info->scale_accessibility_help = RNAplex_args_info_detailed_help[34] ;
  args_info->constraint_help = RNAplex_args_info_detailed_help[36] ;
  args_info->alignment_mode_help = RNAplex_args_info_detailed_help[38] ;
  args_info->convert_to_bin_help = RNAplex_args_info_detailed_help[40] ;
  args_info->duplex_distance_help = RNAplex_args_info_detailed_help[44] ;
  args_info->energy_threshold_help = RNAplex_args_info_detailed_help[46] ;
  args_info->produce_ps_help = RNAplex_args_info_detailed_help[48] ;
  args_info->WindowLength_help = RNAplex_args_info_detailed_help[50] ;
