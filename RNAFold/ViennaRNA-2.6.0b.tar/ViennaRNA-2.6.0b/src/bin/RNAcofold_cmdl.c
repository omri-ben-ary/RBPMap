...
init_full_help_array(void)
{
  ...
  RNAcofold_args_info_full_help[51] = RNAcofold_args_info_detailed_help[78];
  RNAcofold_args_info_full_help[52] = RNAcofold_args_info_detailed_help[79];
  RNAcofold_args_info_full_help[53] = RNAcofold_args_info_detailed_help[81];
  RNAcofold_args_info_full_help[54] = RNAcofold_args_info_detailed_help[83];
  ...
  RNAcofold_args_info_full_help[57] = 0; 
  
}

const char *RNAcofold_args_info_full_help[58];
...
init_help_array(void)
{
  ...
  RNAcofold_args_info_help[39] = RNAcofold_args_info_detailed_help[79];
  RNAcofold_args_info_help[40] = RNAcofold_args_info_detailed_help[86];
  RNAcofold_args_info_help[41] = 0; 
  
}

const char *RNAcofold_args_info_help[42];
...
void init_args_info(struct RNAcofold_args_info *args_info)
{
  ...
  args_info->salt_help = RNAcofold_args_info_detailed_help[77] ;
  args_info->saltInit_help = RNAcofold_args_info_detailed_help[78] ;
  args_info->paramFile_help = RNAcofold_args_info_detailed_help[79] ;
  args_info->nsp_help = RNAcofold_args_info_detailed_help[81] ;
  args_info->energyModel_help = RNAcofold_args_info_detailed_help[83] ;
  args_info->betaScale_help = RNAcofold_args_info_detailed_help[84] ;
