...
init_help_array(void)
{
  ...
  PKplex_args_info_help[7] = PKplex_args_info_detailed_help[8];
  PKplex_args_info_help[8] = PKplex_args_info_detailed_help[9];
  PKplex_args_info_help[9] = PKplex_args_info_detailed_help[10];
  PKplex_args_info_help[10] = PKplex_args_info_detailed_help[11];
  PKplex_args_info_help[11] = PKplex_args_info_detailed_help[12];
  PKplex_args_info_help[12] = PKplex_args_info_detailed_help[14];
  PKplex_args_info_help[13] = PKplex_args_info_detailed_help[15];
  PKplex_args_info_help[14] = PKplex_args_info_detailed_help[17];
  PKplex_args_info_help[15] = PKplex_args_info_detailed_help[18];
  PKplex_args_info_help[16] = PKplex_args_info_detailed_help[20];
  PKplex_args_info_help[17] = 0; 
  
}

const char *PKplex_args_info_help[18];
...
void clear_args (struct PKplex_args_info *args_info)
{
  ...
  args_info->nsp_arg = gengetopt_strdup ("empty");
...
void init_args_info(struct PKplex_args_info *args_info)
{
  ...
  args_info->version_help = PKplex_args_info_detailed_help[2] ;
  args_info->cutoff_help = PKplex_args_info_detailed_help[3] ;
  args_info->temp_help = PKplex_args_info_detailed_help[4] ;
  args_info->noTetra_help = PKplex_args_info_detailed_help[5] ;
  args_info->noLP_help = PKplex_args_info_detailed_help[6] ;
  args_info->noGU_help = PKplex_args_info_detailed_help[8] ;
  args_info->noClosingGU_help = PKplex_args_info_detailed_help[9] ;
  args_info->salt_help = PKplex_args_info_detailed_help[10] ;
  args_info->noconv_help = PKplex_args_info_detailed_help[11] ;
  args_info->nsp_help = PKplex_args_info_detailed_help[12] ;
  args_info->energyCutoff_help = PKplex_args_info_detailed_help[14] ;
  args_info->paramFile_help = PKplex_args_info_detailed_help[15] ;
  args_info->verbose_help = PKplex_args_info_detailed_help[17] ;
  args_info->subopts_help = PKplex_args_info_detailed_help[18] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVc:T:4e:P:vs:", long_options, &option_index);
...
.  */
          if (strcmp (long_options[option_index].name, "noLP") == 0)
          {
...
.  */
          else if (strcmp (long_options[option_index].name, "nsp") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->nsp_arg), 
                ...
                &(local_args_info.nsp_given), optarg, 0, "empty", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "nsp", '-',
                additional_error))
              goto failure;
