...
.  */
 ...
 help description.  */
  char * id_prefix_arg;	/**< @brief Set prefix for automatically generated IDs
 (default='sequence').  */
  char * id_prefix_orig;	/**< @brief Set prefix for automatically generated IDs
 original value given at command line.  */
  const char *id_prefix_help; /**< @brief Set prefix for automatically generated IDs
 help description.  */
  char * id_delim_arg;	/**< @brief Change prefix delimiter for automatically generated ids.
 (default='_').  */
  char * id_delim_orig;	/**< @brief Change prefix delimiter for automatically generated ids.
 original value given at command line.  */
  const char *id_delim_help; /**< @brief Change prefix delimiter for automatically generated ids.
 help description.  */
...
.  */
 ...
 help description.  */
  char * shapeMethod_arg;	/**< @brief Include SHAPE reactivity data according to a particular method.
 (default='D').  */
  char * shapeMethod_orig;	/**< @brief Include SHAPE reactivity data according to a particular method.
 original value given at command line.  */
  const char *shapeMethod_help; /**< @brief Include SHAPE reactivity data according to a particular method.
 help description.  */
  char * shapeConversion_arg;	/**< @brief Convert SHAPE reactivity according to a particular model.
 (default='O').  */
  char * shapeConversion_orig;	/**< @brief Convert SHAPE reactivity according to a particular model.
 original value given at command line.  */
  const char *shapeConversion_help; /**< @brief Convert SHAPE reactivity according to a particular model.
 help description.  */
...
.  */
 ...
 help description.  */
  int dangles_arg;	/**< @brief Change the dangling end model
 (default='2').  */
  char * dangles_orig;	/**< @brief Change the dangling end model
 original value given at command line.  */
  const char *dangles_help; /**< @brief Change the dangling end model
 help description.  */
