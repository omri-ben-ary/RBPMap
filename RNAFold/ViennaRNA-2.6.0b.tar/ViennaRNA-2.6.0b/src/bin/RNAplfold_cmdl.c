...
init_full_help_array(void)
{
  ...
  RNAplfold_args_info_full_help[10] = RNAplfold_args_info_detailed_help[11];
  ...
  RNAplfold_args_info_full_help[13] = RNAplfold_args_info_detailed_help[17];
  RNAplfold_args_info_full_help[14] = RNAplfold_args_info_detailed_help[18];
  RNAplfold_args_info_full_help[15] = RNAplfold_args_info_detailed_help[19];
  RNAplfold_args_info_full_help[16] = RNAplfold_args_info_detailed_help[21];
  RNAplfold_args_info_full_help[17] = RNAplfold_args_info_detailed_help[23];
  RNAplfold_args_info_full_help[18] = RNAplfold_args_info_detailed_help[25];
  RNAplfold_args_info_full_help[19] = RNAplfold_args_info_detailed_help[27];
  RNAplfold_args_info_full_help[20] = RNAplfold_args_info_detailed_help[29];
  RNAplfold_args_info_full_help[21] = RNAplfold_args_info_detailed_help[31];
  RNAplfold_args_info_full_help[22] = RNAplfold_args_info_detailed_help[33];
  RNAplfold_args_info_full_help[23] = RNAplfold_args_info_detailed_help[34];
  RNAplfold_args_info_full_help[24] = RNAplfold_args_info_detailed_help[36];
  RNAplfold_args_info_full_help[25] = RNAplfold_args_info_detailed_help[38];
  RNAplfold_args_info_full_help[26] = RNAplfold_args_info_detailed_help[40];
  ...
  RNAplfold_args_info_full_help[29] = RNAplfold_args_info_detailed_help[44];
  RNAplfold_args_info_full_help[30] = RNAplfold_args_info_detailed_help[46];
  RNAplfold_args_info_full_help[31] = RNAplfold_args_info_detailed_help[48];
  RNAplfold_args_info_full_help[32] = RNAplfold_args_info_detailed_help[49];
  ...
  RNAplfold_args_info_full_help[35] = RNAplfold_args_info_detailed_help[53];
  RNAplfold_args_info_full_help[36] = RNAplfold_args_info_detailed_help[55];
  RNAplfold_args_info_full_help[37] = RNAplfold_args_info_detailed_help[57];
  RNAplfold_args_info_full_help[38] = RNAplfold_args_info_detailed_help[59];
  RNAplfold_args_info_full_help[39] = RNAplfold_args_info_detailed_help[61];
  RNAplfold_args_info_full_help[40] = RNAplfold_args_info_detailed_help[63];
  RNAplfold_args_info_full_help[41] = 0; 
  
}

const char *RNAplfold_args_info_full_help[42];
...
init_help_array(void)
{
  ...
  RNAplfold_args_info_help[10] = RNAplfold_args_info_detailed_help[11];
  RNAplfold_args_info_help[11] = RNAplfold_args_info_detailed_help[13];
  RNAplfold_args_info_help[12] = RNAplfold_args_info_detailed_help[15];
  RNAplfold_args_info_help[13] = RNAplfold_args_info_detailed_help[18];
  RNAplfold_args_info_help[14] = RNAplfold_args_info_detailed_help[19];
  RNAplfold_args_info_help[15] = RNAplfold_args_info_detailed_help[21];
  RNAplfold_args_info_help[16] = RNAplfold_args_info_detailed_help[33];
  RNAplfold_args_info_help[17] = RNAplfold_args_info_detailed_help[40];
  ...
  RNAplfold_args_info_help[20] = RNAplfold_args_info_detailed_help[44];
  RNAplfold_args_info_help[21] = RNAplfold_args_info_detailed_help[46];
  RNAplfold_args_info_help[22] = RNAplfold_args_info_detailed_help[48];
  RNAplfold_args_info_help[23] = RNAplfold_args_info_detailed_help[49];
  RNAplfold_args_info_help[24] = RNAplfold_args_info_detailed_help[50];
  RNAplfold_args_info_help[25] = RNAplfold_args_info_detailed_help[51];
  RNAplfold_args_info_help[26] = RNAplfold_args_info_detailed_help[63];
  RNAplfold_args_info_help[27] = 0; 
  
}

const char *RNAplfold_args_info_help[28];
...
void init_args_info(struct RNAplfold_args_info *args_info)
{
  ...
  args_info->verbose_help = RNAplfold_args_info_detailed_help[6] ;
  args_info->winsize_help = RNAplfold_args_info_detailed_help[7] ;
  args_info->span_help = RNAplfold_args_info_detailed_help[8] ;
  args_info->cutoff_help = RNAplfold_args_info_detailed_help[10] ;
  args_info->print_onthefly_help = RNAplfold_args_info_detailed_help[11] ;
  args_info->ulength_help = RNAplfold_args_info_detailed_help[13] ;
  args_info->opening_energies_help = RNAplfold_args_info_detailed_help[15] ;
  args_info->plex_output_help = RNAplfold_args_info_detailed_help[17] ;
  args_info->noconv_help = RNAplfold_args_info_detailed_help[18] ;
  args_info->auto_id_help = RNAplfold_args_info_detailed_help[19] ;
  args_info->id_prefix_help = RNAplfold_args_info_detailed_help[21] ;
  args_info->id_delim_help = RNAplfold_args_info_detailed_help[23] ;
  args_info->id_digits_help = RNAplfold_args_info_detailed_help[25] ;
  args_info->id_start_help = RNAplfold_args_info_detailed_help[27] ;
  args_info->filename_delim_help = RNAplfold_args_info_detailed_help[29] ;
  args_info->filename_full_help = RNAplfold_args_info_detailed_help[31] ;
  args_info->shape_help = RNAplfold_args_info_detailed_help[33] ;
  args_info->shapeMethod_help = RNAplfold_args_info_detailed_help[34] ;
  args_info->shapeConversion_help = RNAplfold_args_info_detailed_help[36] ;
  args_info->commands_help = RNAplfold_args_info_detailed_help[38] ;
  args_info->temp_help = RNAplfold_args_info_detailed_help[41] ;
  args_info->noTetra_help = RNAplfold_args_info_detailed_help[42] ;
  args_info->dangles_help = RNAplfold_args_info_detailed_help[44] ;
  args_info->noLP_help = RNAplfold_args_info_detailed_help[46] ;
  args_info->noGU_help = RNAplfold_args_info_detailed_help[48] ;
  args_info->noClosingGU_help = RNAplfold_args_info_detailed_help[49] ;
  args_info->salt_help = RNAplfold_args_info_detailed_help[50] ;
  args_info->paramFile_help = RNAplfold_args_info_detailed_help[51] ;
  args_info->pfScale_help = RNAplfold_args_info_detailed_help[53] ;
  args_info->binaries_help = RNAplfold_args_info_detailed_help[55] ;
  args_info->nsp_help = RNAplfold_args_info_detailed_help[57] ;
  args_info->energyModel_help = RNAplfold_args_info_detailed_help[59] ;
  args_info->betaScale_help = RNAplfold_args_info_detailed_help[61] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvW:L:c:ou:OT:4d:P:S:be:", long_options, &option_index);
