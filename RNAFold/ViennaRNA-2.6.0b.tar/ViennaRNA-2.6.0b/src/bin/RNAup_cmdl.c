...
const char *RNAup_args_info_detailed_help[] = {
  ...
  "  -C, --constraint            Apply structural constraint(s) during prediction.\n                                (default=off)",
  ...
  "  -o, --no_output_file        Do not produce an output file.  (default=off)",
  ...
  "  Mostly for testing.\n",
  "  -d, --dangles=INT           Specify \"dangling end\" model for bases adjacent\n                                to helices in free ends and multi-loops.\n                                (default=`2')",
  ...
  "      --saltInit=DOUBLE       Provide salt correction for duplex initialization\n                                (in kcal/mol).\n\n",
...
init_full_help_array(void)
{
  ...
  RNAup_args_info_full_help[16] = RNAup_args_info_detailed_help[20];
  RNAup_args_info_full_help[17] = RNAup_args_info_detailed_help[22];
  RNAup_args_info_full_help[18] = RNAup_args_info_detailed_help[24];
  RNAup_args_info_full_help[19] = RNAup_args_info_detailed_help[26];
  RNAup_args_info_full_help[20] = RNAup_args_info_detailed_help[28];
  RNAup_args_info_full_help[21] = RNAup_args_info_detailed_help[29];
  RNAup_args_info_full_help[22] = RNAup_args_info_detailed_help[31];
  RNAup_args_info_full_help[23] = RNAup_args_info_detailed_help[32];
  RNAup_args_info_full_help[24] = RNAup_args_info_detailed_help[34];
  RNAup_args_info_full_help[25] = RNAup_args_info_detailed_help[36];
  RNAup_args_info_full_help[26] = RNAup_args_info_detailed_help[38];
  RNAup_args_info_full_help[27] = RNAup_args_info_detailed_help[39];
  RNAup_args_info_full_help[28] = RNAup_args_info_detailed_help[40];
  RNAup_args_info_full_help[29] = RNAup_args_info_detailed_help[41];
  RNAup_args_info_full_help[30] = RNAup_args_info_detailed_help[42];
  RNAup_args_info_full_help[31] = RNAup_args_info_detailed_help[44];
  RNAup_args_info_full_help[32] = RNAup_args_info_detailed_help[46];
  RNAup_args_info_full_help[33] = RNAup_args_info_detailed_help[48];
  RNAup_args_info_full_help[34] = 0; 
  
}

const char *RNAup_args_info_full_help[35];
...
init_help_array(void)
{
  ...
  RNAup_args_info_help[16] = RNAup_args_info_detailed_help[20];
  RNAup_args_info_help[17] = RNAup_args_info_detailed_help[22];
  RNAup_args_info_help[18] = RNAup_args_info_detailed_help[24];
  RNAup_args_info_help[19] = RNAup_args_info_detailed_help[26];
  RNAup_args_info_help[20] = RNAup_args_info_detailed_help[28];
  RNAup_args_info_help[21] = RNAup_args_info_detailed_help[31];
  RNAup_args_info_help[22] = RNAup_args_info_detailed_help[32];
  RNAup_args_info_help[23] = RNAup_args_info_detailed_help[34];
  RNAup_args_info_help[24] = RNAup_args_info_detailed_help[36];
  RNAup_args_info_help[25] = RNAup_args_info_detailed_help[38];
  RNAup_args_info_help[26] = RNAup_args_info_detailed_help[39];
  RNAup_args_info_help[27] = RNAup_args_info_detailed_help[40];
  RNAup_args_info_help[28] = RNAup_args_info_detailed_help[42];
  RNAup_args_info_help[29] = RNAup_args_info_detailed_help[48];
  RNAup_args_info_help[30] = 0; 
  
}

const char *RNAup_args_info_help[31];
...
void init_args_info(struct RNAup_args_info *args_info)
{
  ...
  args_info->extend5_help = RNAup_args_info_detailed_help[20] ;
  args_info->extend3_help = RNAup_args_info_detailed_help[22] ;
  args_info->interaction_pairwise_help = RNAup_args_info_detailed_help[24] ;
  args_info->interaction_first_help = RNAup_args_info_detailed_help[26] ;
  args_info->pfScale_help = RNAup_args_info_detailed_help[29] ;
  args_info->temp_help = RNAup_args_info_detailed_help[31] ;
  args_info->noTetra_help = RNAup_args_info_detailed_help[32] ;
  args_info->dangles_help = RNAup_args_info_detailed_help[34] ;
  args_info->noLP_help = RNAup_args_info_detailed_help[36] ;
  args_info->noGU_help = RNAup_args_info_detailed_help[38] ;
  args_info->noClosingGU_help = RNAup_args_info_detailed_help[39] ;
  args_info->salt_help = RNAup_args_info_detailed_help[40] ;
  args_info->saltInit_help = RNAup_args_info_detailed_help[41] ;
  args_info->paramFile_help = RNAup_args_info_detailed_help[42] ;
  args_info->nsp_help = RNAup_args_info_detailed_help[44] ;
  args_info->energyModel_help = RNAup_args_info_detailed_help[46] ;
