...
const char *RNAaliduplex_args_info_detailed_help[] = {
  ...
  "  -s, --sorted               print output sorted by free energy\n\n                                 (default=off)",
  "\nModel Details:",
...
init_full_help_array(void)
{
  ...
  RNAaliduplex_args_info_full_help[20] = 0; 
  
}

const char *RNAaliduplex_args_info_full_help[21];
...
init_help_array(void)
{
  ...
  RNAaliduplex_args_info_help[12] = RNAaliduplex_args_info_detailed_help[13];
  RNAaliduplex_args_info_help[13] = RNAaliduplex_args_info_detailed_help[15];
  RNAaliduplex_args_info_help[14] = RNAaliduplex_args_info_detailed_help[16];
  RNAaliduplex_args_info_help[15] = RNAaliduplex_args_info_detailed_help[17];
  RNAaliduplex_args_info_help[16] = RNAaliduplex_args_info_detailed_help[19];
  RNAaliduplex_args_info_help[17] = RNAaliduplex_args_info_detailed_help[21];
  RNAaliduplex_args_info_help[18] = RNAaliduplex_args_info_detailed_help[23];
  RNAaliduplex_args_info_help[19] = 0; 
  
}

const char *RNAaliduplex_args_info_help[20];
...
void init_args_info(struct RNAaliduplex_args_info *args_info)
{
  ...
  args_info->temp_help = RNAaliduplex_args_info_detailed_help[9] ;
  args_info->noTetra_help = RNAaliduplex_args_info_detailed_help[10] ;
  args_info->dangles_help = RNAaliduplex_args_info_detailed_help[11] ;
  args_info->noLP_help = RNAaliduplex_args_info_detailed_help[13] ;
  args_info->noGU_help = RNAaliduplex_args_info_detailed_help[15] ;
  args_info->noClosingGU_help = RNAaliduplex_args_info_detailed_help[16] ;
  args_info->salt_help = RNAaliduplex_args_info_detailed_help[17] ;
  args_info->saltInit_help = RNAaliduplex_args_info_detailed_help[18] ;
  args_info->nsp_help = RNAaliduplex_args_info_detailed_help[19] ;
  args_info->paramFile_help = RNAaliduplex_args_info_detailed_help[21] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVe:sT:4d:P:", long_options, &option_index);
...
.  */
          ...
          break;
        case 's':	/* print output sorted by free energy
