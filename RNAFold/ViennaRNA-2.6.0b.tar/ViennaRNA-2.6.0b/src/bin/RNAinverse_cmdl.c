...
const char *RNAinverse_args_info_detailed_help[] = {
  ...
  "  -a, --alphabet=ALPHABET    Find sequences using only nucleotides from a given\n                               alphabet.\n\n",
...
init_full_help_array(void)
{
  ...
  RNAinverse_args_info_full_help[7] = RNAinverse_args_info_detailed_help[8];
  ...
  RNAinverse_args_info_full_help[10] = RNAinverse_args_info_detailed_help[11];
  RNAinverse_args_info_full_help[11] = RNAinverse_args_info_detailed_help[12];
  ...
  RNAinverse_args_info_full_help[15] = RNAinverse_args_info_detailed_help[17];
  RNAinverse_args_info_full_help[16] = RNAinverse_args_info_detailed_help[18];
  RNAinverse_args_info_full_help[17] = RNAinverse_args_info_detailed_help[20];
  RNAinverse_args_info_full_help[18] = RNAinverse_args_info_detailed_help[21];
  RNAinverse_args_info_full_help[19] = RNAinverse_args_info_detailed_help[22];
  RNAinverse_args_info_full_help[20] = RNAinverse_args_info_detailed_help[23];
  RNAinverse_args_info_full_help[21] = RNAinverse_args_info_detailed_help[25];
  RNAinverse_args_info_full_help[22] = RNAinverse_args_info_detailed_help[27];
  RNAinverse_args_info_full_help[23] = RNAinverse_args_info_detailed_help[28];
  RNAinverse_args_info_full_help[24] = 0; 
  
}

const char *RNAinverse_args_info_full_help[25];
...
init_help_array(void)
{
  ...
  RNAinverse_args_info_help[7] = RNAinverse_args_info_detailed_help[8];
  ...
  RNAinverse_args_info_help[10] = RNAinverse_args_info_detailed_help[11];
  RNAinverse_args_info_help[11] = RNAinverse_args_info_detailed_help[12];
  ...
  RNAinverse_args_info_help[15] = RNAinverse_args_info_detailed_help[17];
  RNAinverse_args_info_help[16] = RNAinverse_args_info_detailed_help[18];
  RNAinverse_args_info_help[17] = RNAinverse_args_info_detailed_help[20];
  RNAinverse_args_info_help[18] = RNAinverse_args_info_detailed_help[21];
  RNAinverse_args_info_help[19] = RNAinverse_args_info_detailed_help[22];
  RNAinverse_args_info_help[20] = RNAinverse_args_info_detailed_help[23];
  RNAinverse_args_info_help[21] = RNAinverse_args_info_detailed_help[28];
  RNAinverse_args_info_help[22] = 0; 
  
}

const char *RNAinverse_args_info_help[23];
...
void init_args_info(struct RNAinverse_args_info *args_info)
{
  ...
  args_info->repeat_help = RNAinverse_args_info_detailed_help[6] ;
  args_info->alphabet_help = RNAinverse_args_info_detailed_help[8] ;
  args_info->verbose_help = RNAinverse_args_info_detailed_help[9] ;
  args_info->function_help = RNAinverse_args_info_detailed_help[12] ;
  args_info->final_help = RNAinverse_args_info_detailed_help[14] ;
  args_info->temp_help = RNAinverse_args_info_detailed_help[16] ;
  args_info->noTetra_help = RNAinverse_args_info_detailed_help[17] ;
  args_info->dangles_help = RNAinverse_args_info_detailed_help[18] ;
  args_info->noGU_help = RNAinverse_args_info_detailed_help[20] ;
  args_info->noClosingGU_help = RNAinverse_args_info_detailed_help[21] ;
  args_info->salt_help = RNAinverse_args_info_detailed_help[22] ;
  args_info->paramFile_help = RNAinverse_args_info_detailed_help[23] ;
  args_info->nsp_help = RNAinverse_args_info_detailed_help[25] ;
  args_info->energyModel_help = RNAinverse_args_info_detailed_help[27] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVR::a:vF:f:T:4d:P:e:", long_options, &option_index);
...
.  */
          ...
          if (update_arg( (void *)&(args_info->repeat_arg), 
              ...
              &(local_args_info.repeat_given), optarg, 0, "100", ARG_INT,
