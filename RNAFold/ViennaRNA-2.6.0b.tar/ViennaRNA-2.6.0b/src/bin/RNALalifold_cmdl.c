...
init_full_help_array(void)
{
  ...
  RNALalifold_args_info_full_help[9] = RNALalifold_args_info_detailed_help[10];
  RNALalifold_args_info_full_help[10] = RNALalifold_args_info_detailed_help[12];
  RNALalifold_args_info_full_help[11] = RNALalifold_args_info_detailed_help[13];
  RNALalifold_args_info_full_help[12] = RNALalifold_args_info_detailed_help[15];
  ...
  RNALalifold_args_info_full_help[15] = RNALalifold_args_info_detailed_help[21];
  RNALalifold_args_info_full_help[16] = RNALalifold_args_info_detailed_help[23];
  RNALalifold_args_info_full_help[17] = RNALalifold_args_info_detailed_help[25];
  RNALalifold_args_info_full_help[18] = RNALalifold_args_info_detailed_help[27];
  RNALalifold_args_info_full_help[19] = RNALalifold_args_info_detailed_help[29];
  RNALalifold_args_info_full_help[20] = RNALalifold_args_info_detailed_help[31];
  RNALalifold_args_info_full_help[21] = RNALalifold_args_info_detailed_help[33];
  RNALalifold_args_info_full_help[22] = RNALalifold_args_info_detailed_help[35];
  RNALalifold_args_info_full_help[23] = RNALalifold_args_info_detailed_help[37];
  RNALalifold_args_info_full_help[24] = RNALalifold_args_info_detailed_help[38];
  RNALalifold_args_info_full_help[25] = RNALalifold_args_info_detailed_help[39];
  RNALalifold_args_info_full_help[26] = RNALalifold_args_info_detailed_help[41];
  RNALalifold_args_info_full_help[27] = RNALalifold_args_info_detailed_help[43];
  RNALalifold_args_info_full_help[28] = RNALalifold_args_info_detailed_help[44];
  RNALalifold_args_info_full_help[29] = RNALalifold_args_info_detailed_help[45];
  RNALalifold_args_info_full_help[30] = RNALalifold_args_info_detailed_help[46];
  RNALalifold_args_info_full_help[31] = RNALalifold_args_info_detailed_help[47];
  RNALalifold_args_info_full_help[32] = RNALalifold_args_info_detailed_help[48];
  RNALalifold_args_info_full_help[33] = RNALalifold_args_info_detailed_help[49];
  RNALalifold_args_info_full_help[34] = RNALalifold_args_info_detailed_help[50];
  RNALalifold_args_info_full_help[35] = RNALalifold_args_info_detailed_help[51];
  RNALalifold_args_info_full_help[36] = RNALalifold_args_info_detailed_help[52];
  RNALalifold_args_info_full_help[37] = RNALalifold_args_info_detailed_help[54];
  RNALalifold_args_info_full_help[38] = RNALalifold_args_info_detailed_help[56];
  RNALalifold_args_info_full_help[39] = RNALalifold_args_info_detailed_help[57];
  RNALalifold_args_info_full_help[40] = RNALalifold_args_info_detailed_help[58];
  RNALalifold_args_info_full_help[41] = RNALalifold_args_info_detailed_help[59];
  RNALalifold_args_info_full_help[42] = RNALalifold_args_info_detailed_help[61];
  RNALalifold_args_info_full_help[43] = RNALalifold_args_info_detailed_help[63];
  RNALalifold_args_info_full_help[44] = RNALalifold_args_info_detailed_help[64];
  RNALalifold_args_info_full_help[45] = RNALalifold_args_info_detailed_help[65];
  RNALalifold_args_info_full_help[46] = RNALalifold_args_info_detailed_help[66];
  RNALalifold_args_info_full_help[47] = RNALalifold_args_info_detailed_help[67];
  RNALalifold_args_info_full_help[48] = RNALalifold_args_info_detailed_help[68];
  RNALalifold_args_info_full_help[49] = 0; 
  
}

const char *RNALalifold_args_info_full_help[50];
...
init_help_array(void)
{
  ...
  RNALalifold_args_info_help[9] = RNALalifold_args_info_detailed_help[10];
  RNALalifold_args_info_help[10] = RNALalifold_args_info_detailed_help[12];
  RNALalifold_args_info_help[11] = RNALalifold_args_info_detailed_help[13];
  RNALalifold_args_info_help[12] = RNALalifold_args_info_detailed_help[15];
  RNALalifold_args_info_help[13] = RNALalifold_args_info_detailed_help[19];
  RNALalifold_args_info_help[14] = RNALalifold_args_info_detailed_help[21];
  RNALalifold_args_info_help[15] = RNALalifold_args_info_detailed_help[23];
  RNALalifold_args_info_help[16] = RNALalifold_args_info_detailed_help[25];
  RNALalifold_args_info_help[17] = RNALalifold_args_info_detailed_help[35];
  RNALalifold_args_info_help[18] = RNALalifold_args_info_detailed_help[37];
  RNALalifold_args_info_help[19] = RNALalifold_args_info_detailed_help[38];
  RNALalifold_args_info_help[20] = RNALalifold_args_info_detailed_help[39];
  RNALalifold_args_info_help[21] = RNALalifold_args_info_detailed_help[41];
  RNALalifold_args_info_help[22] = RNALalifold_args_info_detailed_help[43];
  RNALalifold_args_info_help[23] = RNALalifold_args_info_detailed_help[44];
  RNALalifold_args_info_help[24] = RNALalifold_args_info_detailed_help[45];
  RNALalifold_args_info_help[25] = RNALalifold_args_info_detailed_help[46];
  RNALalifold_args_info_help[26] = RNALalifold_args_info_detailed_help[47];
  RNALalifold_args_info_help[27] = RNALalifold_args_info_detailed_help[48];
  RNALalifold_args_info_help[28] = RNALalifold_args_info_detailed_help[49];
  ...
  RNALalifold_args_info_help[32] = RNALalifold_args_info_detailed_help[54];
  RNALalifold_args_info_help[33] = RNALalifold_args_info_detailed_help[56];
  RNALalifold_args_info_help[34] = RNALalifold_args_info_detailed_help[57];
  RNALalifold_args_info_help[35] = RNALalifold_args_info_detailed_help[58];
  RNALalifold_args_info_help[36] = RNALalifold_args_info_detailed_help[59];
  RNALalifold_args_info_help[37] = RNALalifold_args_info_detailed_help[64];
  RNALalifold_args_info_help[38] = RNALalifold_args_info_detailed_help[65];
  RNALalifold_args_info_help[39] = RNALalifold_args_info_detailed_help[66];
  RNALalifold_args_info_help[40] = RNALalifold_args_info_detailed_help[67];
  RNALalifold_args_info_help[41] = RNALalifold_args_info_detailed_help[68];
  RNALalifold_args_info_help[42] = 0; 
  
}

const char *RNALalifold_args_info_help[43];
...
void init_args_info(struct RNALalifold_args_info *args_info)
{
  ...
  args_info->verbose_help = RNALalifold_args_info_detailed_help[6] ;
  args_info->quiet_help = RNALalifold_args_info_detailed_help[7] ;
  args_info->noconv_help = RNALalifold_args_info_detailed_help[9] ;
  args_info->input_format_help = RNALalifold_args_info_detailed_help[10] ;
  args_info->csv_help = RNALalifold_args_info_detailed_help[12] ;
  args_info->aln_help = RNALalifold_args_info_detailed_help[13] ;
  args_info->aln_EPS_help = RNALalifold_args_info_detailed_help[15] ;
  args_info->aln_EPS_cols_help = RNALalifold_args_info_detailed_help[17] ;
  args_info->aln_EPS_ss_help = RNALalifold_args_info_detailed_help[19] ;
  args_info->aln_stk_help = RNALalifold_args_info_detailed_help[21] ;
  args_info->auto_id_help = RNALalifold_args_info_detailed_help[23] ;
  args_info->id_prefix_help = RNALalifold_args_info_detailed_help[25] ;
  args_info->id_delim_help = RNALalifold_args_info_detailed_help[27] ;
  args_info->id_digits_help = RNALalifold_args_info_detailed_help[29] ;
  args_info->id_start_help = RNALalifold_args_info_detailed_help[31] ;
  args_info->filename_delim_help = RNALalifold_args_info_detailed_help[33] ;
  args_info->split_contributions_help = RNALalifold_args_info_detailed_help[35] ;
  ...
  args_info->maxBPspan_help = RNALalifold_args_info_detailed_help[45] ;
  args_info->threshold_help = RNALalifold_args_info_detailed_help[46] ;
  args_info->mis_help = RNALalifold_args_info_detailed_help[47] ;
  args_info->gquad_help = RNALalifold_args_info_detailed_help[48] ;
  args_info->temp_help = RNALalifold_args_info_detailed_help[50] ;
  args_info->noTetra_help = RNALalifold_args_info_detailed_help[51] ;
  args_info->dangles_help = RNALalifold_args_info_detailed_help[52] ;
  args_info->noLP_help = RNALalifold_args_info_detailed_help[54] ;
  args_info->noGU_help = RNALalifold_args_info_detailed_help[56] ;
  args_info->noClosingGU_help = RNALalifold_args_info_detailed_help[57] ;
  args_info->salt_help = RNALalifold_args_info_detailed_help[58] ;
  args_info->paramFile_help = RNALalifold_args_info_detailed_help[59] ;
  args_info->nsp_help = RNALalifold_args_info_detailed_help[61] ;
  args_info->energyModel_help = RNALalifold_args_info_detailed_help[63] ;
  args_info->cfactor_help = RNALalifold_args_info_detailed_help[64] ;
  args_info->nfactor_help = RNALalifold_args_info_detailed_help[65] ;
  args_info->ribosum_file_help = RNALalifold_args_info_detailed_help[66] ;
  args_info->ribosum_scoring_help = RNALalifold_args_info_detailed_help[67] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvqf:L:gT:4d:P:e:R:r", long_options, &option_index);
