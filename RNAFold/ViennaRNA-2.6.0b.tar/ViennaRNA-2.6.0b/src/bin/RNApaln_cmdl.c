...
init_full_help_array(void)
{
  ...
  RNApaln_args_info_full_help[27] = 0; 
  
}

const char *RNApaln_args_info_full_help[28];
...
init_help_array(void)
{
  ...
  RNApaln_args_info_help[19] = RNApaln_args_info_detailed_help[22];
  RNApaln_args_info_help[20] = RNApaln_args_info_detailed_help[24];
  RNApaln_args_info_help[21] = RNApaln_args_info_detailed_help[25];
  RNApaln_args_info_help[22] = RNApaln_args_info_detailed_help[26];
  RNApaln_args_info_help[23] = RNApaln_args_info_detailed_help[27];
  RNApaln_args_info_help[24] = RNApaln_args_info_detailed_help[32];
...
void init_args_info(struct RNApaln_args_info *args_info)
{
  ...
  args_info->gapo_help = RNApaln_args_info_detailed_help[14] ;
  args_info->gape_help = RNApaln_args_info_detailed_help[15] ;
  args_info->seqw_help = RNApaln_args_info_detailed_help[16] ;
  args_info->endgaps_help = RNApaln_args_info_detailed_help[17] ;
  args_info->temp_help = RNApaln_args_info_detailed_help[18] ;
  args_info->noTetra_help = RNApaln_args_info_detailed_help[19] ;
  args_info->dangles_help = RNApaln_args_info_detailed_help[20] ;
  args_info->noLP_help = RNApaln_args_info_detailed_help[22] ;
  args_info->noGU_help = RNApaln_args_info_detailed_help[24] ;
  args_info->noClosingGU_help = RNApaln_args_info_detailed_help[25] ;
  args_info->salt_help = RNApaln_args_info_detailed_help[26] ;
  args_info->paramFile_help = RNApaln_args_info_detailed_help[27] ;
  args_info->nsp_help = RNApaln_args_info_detailed_help[29] ;
  args_info->energyModel_help = RNApaln_args_info_detailed_help[31] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVB::X:T:4d:P:e:", long_options, &option_index);
