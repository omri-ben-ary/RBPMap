...
init_full_help_array(void)
{
  ...
  RNAeval_args_info_full_help[14] = RNAeval_args_info_detailed_help[20];
  RNAeval_args_info_full_help[15] = RNAeval_args_info_detailed_help[22];
  RNAeval_args_info_full_help[16] = RNAeval_args_info_detailed_help[24];
  RNAeval_args_info_full_help[17] = RNAeval_args_info_detailed_help[26];
  ...
  RNAeval_args_info_full_help[21] = RNAeval_args_info_detailed_help[31];
  RNAeval_args_info_full_help[22] = RNAeval_args_info_detailed_help[32];
  RNAeval_args_info_full_help[23] = RNAeval_args_info_detailed_help[34];
  RNAeval_args_info_full_help[24] = RNAeval_args_info_detailed_help[36];
  RNAeval_args_info_full_help[25] = RNAeval_args_info_detailed_help[37];
  RNAeval_args_info_full_help[26] = RNAeval_args_info_detailed_help[38];
  RNAeval_args_info_full_help[27] = RNAeval_args_info_detailed_help[39];
  RNAeval_args_info_full_help[28] = RNAeval_args_info_detailed_help[41];
  RNAeval_args_info_full_help[29] = RNAeval_args_info_detailed_help[42];
  RNAeval_args_info_full_help[30] = RNAeval_args_info_detailed_help[44];
  RNAeval_args_info_full_help[31] = RNAeval_args_info_detailed_help[46];
  RNAeval_args_info_full_help[32] = RNAeval_args_info_detailed_help[47];
  RNAeval_args_info_full_help[33] = RNAeval_args_info_detailed_help[48];
  RNAeval_args_info_full_help[34] = RNAeval_args_info_detailed_help[49];
  RNAeval_args_info_full_help[35] = RNAeval_args_info_detailed_help[50];
  RNAeval_args_info_full_help[36] = RNAeval_args_info_detailed_help[51];
  RNAeval_args_info_full_help[37] = RNAeval_args_info_detailed_help[52];
  RNAeval_args_info_full_help[38] = 0; 
  
}

const char *RNAeval_args_info_full_help[39];
...
init_help_array(void)
{
  ...
  RNAeval_args_info_help[9] = RNAeval_args_info_detailed_help[12];
  RNAeval_args_info_help[10] = RNAeval_args_info_detailed_help[14];
  RNAeval_args_info_help[11] = RNAeval_args_info_detailed_help[16];
  RNAeval_args_info_help[12] = RNAeval_args_info_detailed_help[18];
  RNAeval_args_info_help[13] = RNAeval_args_info_detailed_help[20];
  RNAeval_args_info_help[14] = RNAeval_args_info_detailed_help[26];
  RNAeval_args_info_help[15] = RNAeval_args_info_detailed_help[27];
  RNAeval_args_info_help[16] = RNAeval_args_info_detailed_help[28];
  RNAeval_args_info_help[17] = RNAeval_args_info_detailed_help[29];
  RNAeval_args_info_help[18] = RNAeval_args_info_detailed_help[31];
  RNAeval_args_info_help[19] = RNAeval_args_info_detailed_help[32];
  RNAeval_args_info_help[20] = RNAeval_args_info_detailed_help[36];
  RNAeval_args_info_help[21] = RNAeval_args_info_detailed_help[37];
  RNAeval_args_info_help[22] = RNAeval_args_info_detailed_help[38];
  RNAeval_args_info_help[23] = RNAeval_args_info_detailed_help[39];
  RNAeval_args_info_help[24] = RNAeval_args_info_detailed_help[41];
  RNAeval_args_info_help[25] = RNAeval_args_info_detailed_help[42];
  RNAeval_args_info_help[26] = RNAeval_args_info_detailed_help[44];
  ...
  RNAeval_args_info_help[30] = RNAeval_args_info_detailed_help[49];
  RNAeval_args_info_help[31] = RNAeval_args_info_detailed_help[50];
  RNAeval_args_info_help[32] = RNAeval_args_info_detailed_help[51];
  RNAeval_args_info_help[33] = RNAeval_args_info_detailed_help[52];
  RNAeval_args_info_help[34] = 0; 
  
}

const char *RNAeval_args_info_help[35];
...
void init_args_info(struct RNAeval_args_info *args_info)
{
  ...
  args_info->jobs_help = RNAeval_args_info_detailed_help[8] ;
  args_info->unordered_help = RNAeval_args_info_detailed_help[10] ;
  args_info->infile_help = RNAeval_args_info_detailed_help[12] ;
  args_info->infile_min = 0;
  args_info->infile_max = 0;
  args_info->msa_help = RNAeval_args_info_detailed_help[14] ;
  args_info->auto_id_help = RNAeval_args_info_detailed_help[16] ;
  args_info->id_prefix_help = RNAeval_args_info_detailed_help[18] ;
  args_info->id_delim_help = RNAeval_args_info_detailed_help[20] ;
  args_info->id_digits_help = RNAeval_args_info_detailed_help[22] ;
  args_info->id_start_help = RNAeval_args_info_detailed_help[24] ;
  args_info->temp_help = RNAeval_args_info_detailed_help[27] ;
  args_info->noTetra_help = RNAeval_args_info_detailed_help[28] ;
  args_info->dangles_help = RNAeval_args_info_detailed_help[29] ;
  args_info->energyModel_help = RNAeval_args_info_detailed_help[31] ;
  args_info->paramFile_help = RNAeval_args_info_detailed_help[32] ;
  args_info->nsp_help = RNAeval_args_info_detailed_help[34] ;
  args_info->circ_help = RNAeval_args_info_detailed_help[36] ;
  args_info->gquad_help = RNAeval_args_info_detailed_help[37] ;
  args_info->salt_help = RNAeval_args_info_detailed_help[38] ;
  args_info->logML_help = RNAeval_args_info_detailed_help[39] ;
  args_info->shape_help = RNAeval_args_info_detailed_help[41] ;
  args_info->shapeMethod_help = RNAeval_args_info_detailed_help[42] ;
  args_info->shapeConversion_help = RNAeval_args_info_detailed_help[44] ;
  args_info->mis_help = RNAeval_args_info_detailed_help[46] ;
  args_info->cfactor_help = RNAeval_args_info_detailed_help[47] ;
  args_info->nfactor_help = RNAeval_args_info_detailed_help[48] ;
  args_info->ribosum_file_help = RNAeval_args_info_detailed_help[49] ;
  args_info->ribosum_scoring_help = RNAeval_args_info_detailed_help[50] ;
  args_info->old_help = RNAeval_args_info_detailed_help[51] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvj::i:aT:4d:e:P:cgR:r", long_options, &option_index);
