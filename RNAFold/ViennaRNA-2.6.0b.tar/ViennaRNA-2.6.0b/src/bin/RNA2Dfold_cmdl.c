...
init_help_array(void)
{
  ...
  RNA2Dfold_args_info_help[24] = RNA2Dfold_args_info_detailed_help[28];
  RNA2Dfold_args_info_help[25] = 0; 
  
}

const char *RNA2Dfold_args_info_help[26];
...
void init_args_info(struct RNA2Dfold_args_info *args_info)
{
  ...
  args_info->paramFile_help = RNA2Dfold_args_info_detailed_help[21] ;
  ...
  args_info->salt_help = RNA2Dfold_args_info_detailed_help[27] ;
