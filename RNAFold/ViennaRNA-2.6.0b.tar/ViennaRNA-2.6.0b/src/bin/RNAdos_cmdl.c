...
init_help_array(void)
{
  ...
  RNAdos_args_info_help[14] = RNAdos_args_info_detailed_help[16];
  RNAdos_args_info_help[15] = RNAdos_args_info_detailed_help[17];
  RNAdos_args_info_help[16] = RNAdos_args_info_detailed_help[18];
  RNAdos_args_info_help[17] = 0; 
  
}

const char *RNAdos_args_info_help[18];
...
void init_args_info(struct RNAdos_args_info *args_info)
{
  ...
  args_info->version_help = RNAdos_args_info_detailed_help[2] ;
  args_info->verbose_help = RNAdos_args_info_detailed_help[5] ;
  args_info->sequence_help = RNAdos_args_info_detailed_help[6] ;
  args_info->max_energy_help = RNAdos_args_info_detailed_help[7] ;
  args_info->numThreads_help = RNAdos_args_info_detailed_help[8] ;
  args_info->temp_help = RNAdos_args_info_detailed_help[10] ;
  args_info->dangles_help = RNAdos_args_info_detailed_help[11] ;
  args_info->salt_help = RNAdos_args_info_detailed_help[13] ;
  args_info->paramFile_help = RNAdos_args_info_detailed_help[14] ;
  args_info->hashtable_bits_help = RNAdos_args_info_detailed_help[17] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvs:e:j:T:d:P:b:", long_options, &option_index);
