...
init_full_help_array(void)
{
  ...
  RNAduplex_args_info_full_help[23] = 0; 
  
}

const char *RNAduplex_args_info_full_help[24];
...
init_help_array(void)
{
  ...
  RNAduplex_args_info_help[19] = RNAduplex_args_info_detailed_help[22];
  RNAduplex_args_info_help[20] = RNAduplex_args_info_detailed_help[26];
...
void init_args_info(struct RNAduplex_args_info *args_info)
{
  ...
  args_info->salt_help = RNAduplex_args_info_detailed_help[20] ;
  args_info->saltInit_help = RNAduplex_args_info_detailed_help[21] ;
  args_info->paramFile_help = RNAduplex_args_info_detailed_help[22] ;
  args_info->nsp_help = RNAduplex_args_info_detailed_help[24] ;
